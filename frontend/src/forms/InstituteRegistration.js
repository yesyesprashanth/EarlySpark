...
import { TextField, MenuItem, Select, FormHelperText, InputLabel, FormControl, Button, Grid } from '@mui/material';
  ...
  return (
    <div className="modal-backdrop">
      <div className="modal-content">
        <h2 className="form-header">Institute/Clinic Registration</h2>
        <form onSubmit={handleSubmit}>
          <Grid container spacing={2}>
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth variant="outlined" size="small" error={errors.type}>
                <InputLabel style={{ color: 'white' }}>Type (Institute/Clinic)</InputLabel>
                <Select
                  label="Type (Institute/Clinic)"
                  name="type"
                  value={formData.type}
                  ...
                  sx={{
                    ...
                    '& .MuiOutlinedInput-notchedOutline': {
                      borderColor: 'white', // Ensures border is white
                    },
                    '& .MuiSelect-icon': {
                    ...
                    '& option': {
                      color: 'black', // Ensures dropdown options are visible (black text)
            ...
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                inputProps={{
                  style: { whiteSpace: 'nowrap', color: 'white' }, // This ensures no wrapping occurs and text is white
                }}
                InputLabelProps={{ style: { color: 'white' } }} // Label color set to white
              />
            </Grid>
            ...
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth size="small" error={errors.nodalCentre}>
                <InputLabel style={{ color: 'white' }}>Nodal Centre</InputLabel>
                <Select
                  name="nodalCentre"
